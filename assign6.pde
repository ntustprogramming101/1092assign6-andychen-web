...
void initGame(){
    ...
    break;
    // Requirement 4: Create new Dinosaur in row 9 - 16(i=2,3)
      case 4: case 5: enemies[i] = new Robot(newX, newY);
    break;
    // Requirement 5: Create new Robot in row 17 - 25(i=4,5)
		}
	...
	for(int i = 0; i < items.length; i++){
		...
		float newY = SOIL_SIZE * ( i * 4 + floor(random(4)));
    items[i]=new Item(newX,newY); //items[i] will be updated according to floors
